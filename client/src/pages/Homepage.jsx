          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-white text-red-500 px-8 py-3 hover:bg-red-500 hover:text-white rounded-full font-semibold transition-colors duration-300 flex items-center gap-2"
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-red-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-300"
          ...
          <div ref={featuredArtistRef} className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((item) => (
              ...
              >
                ...
                >
                  <div>
                    <h3 className="text-lg font-semibold">Mugabo James</h3>
